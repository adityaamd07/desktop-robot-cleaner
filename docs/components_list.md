| Component name | Purpose | Quantity needed | Comment | 
| --- | --- | :---: | ----- | 
| ESP32 DevBoard | Microcontroller | 1 | Component included in ELEGOO starter kit | 
...
| Servo Motor | Source of Motion for Scubbing Mechanism | 1 | Component included in ELEGOO starter kit | 
